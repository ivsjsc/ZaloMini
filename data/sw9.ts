            ...
            lessons: [
                {
                    ...
                    description: {
                        en: 'This lesson explores various effective methods for learning English, including digital tools, traditional techniques, and practical strategies that students can apply in their daily study routine.',
                        vi: 'Bài học này khám phá các phương pháp hiệu quả để học tiếng Anh, bao gồm công cụ số, kỹ thuật truyền thống và chiến lược thực tế mà học sinh có thể áp dụng trong thói quen học tập hàng ngày.'
                    },
                    videoUrl: 'https://example.com/english-learning-methods.mp4',
                    vocabulary: [
                    ...
                    exercises: [
                        {
                            ...
                            question: { en: 'What is the main purpose of using to-infinitives?', vi: 'Mục đích chính của việc sử dụng to-infinitive là gì?' },
                            options: [
                                { en: 'To express time', vi: 'Để diễn tả thời gian' },
                                { en: 'To express purpose', vi: 'Để diễn tả mục đích' },
                                { en: 'To express place', vi: 'Để diễn tả nơi chốn' },
                                { en: 'To express manner', vi: 'Để diễn tả cách thức' }
                            ],
                            correctAnswer: 1,
                            explanation: { en: 'To-infinitives are used to express purpose or reason for doing something.', vi: 'To-infinitive được sử dụng để diễn tả mục đích hoặc lý do làm việc gì đó.' }
                        },
                        {
                            type: 'multiple-choice',
                            question: { en: 'Which phrasal verb means "to search for information"?', vi: 'Cụm động từ nào có nghĩa là "tra cứu thông tin"?' },
                            options: [
                                { en: 'Come across', vi: 'Tình cờ thấy' },
                                { en: 'Look up', vi: 'Tra cứu' },
                                { en: 'Go over', vi: 'Ôn lại' },
                                { en: 'Note down', vi: 'Ghi chép' }
                            ],
                            correctAnswer: 1,
                            explanation: { en: '"Look up" means to search for information in a dictionary, book, or online.', vi: '"Look up" có nghĩa là tra cứu thông tin trong từ điển, sách hoặc trực tuyến.' }
                        }
                    ]
                },
                {
