        ...
        lessons: [
          {
            ...
            exercises: [
              {
                type: 'mcq',
                question: { en: 'What type of home does the person live in?', vi: 'Người đó sống trong loại nhà nào?' },
                options: ['A house', 'An apartment', 'A garage', 'A pool'],
                correctAnswer: 'An apartment',
                explanation: { en: 'The lesson teaches about different types of homes including apartments.', vi: 'Bài học dạy về các loại nhà khác nhau bao gồm căn hộ.' }
              },
              {
                type: 'true-false',
                question: { en: 'We use Present Simple to talk about facts that are true for a long time.', vi: 'Chúng ta dùng thì Hiện tại đơn để nói về những sự thật đúng trong thời gian dài.' },
                correctAnswer: 'True',
                explanation: { en: 'Present Simple is used for permanent situations and facts.', vi: 'Thì Hiện tại đơn được dùng cho các tình huống lâu dài và sự thật.' }
              },
              {
                type: 'fill-blank',
                question: { en: 'Do you live in _____?', vi: 'Bạn có sống trong _____ không?' },
                correctAnswer: 'a house',
                explanation: { en: 'This is the correct structure for Present Simple yes/no questions.', vi: 'Đây là cấu trúc đúng cho câu hỏi Yes/No ở thì Hiện tại đơn.' }
              },
              {
                type: 'reorder',
                question: { en: 'Reorder the words: live / does / she / in / a / house / ?', vi: 'Sắp xếp lại các từ: sống / cô ấy / trong / một / ngôi nhà / không / ?' },
                options: ['live', 'does', 'she', 'in', 'a', 'house', '?'],
                correctAnswer: ['Does', 'she', 'live', 'in', 'a', 'house', '?'],
                explanation: { en: 'The correct word order for a Present Simple yes/no question is: Do/Does + subject + verb + ...?', vi: 'Thứ tự từ đúng cho câu hỏi Yes/No thì Hiện tại đơn là: Do/Does + chủ ngữ + động từ + ...?' }
              }
            ],
          },
          {
