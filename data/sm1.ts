            ...
            lessons: [
                {
                    ...
                    exercises: [
                        {
                            question: { en: 'What number comes after five?', vi: 'Số nào đứng sau số năm?' },
                            options: ['four', 'six', 'seven', 'eight'],
                            correctAnswer: 'six'
                        },
                        {
                            question: { en: 'How do you say "ba" in English?', vi: 'Làm thế nào để nói "ba" bằng tiếng Anh?' },
                            options: ['one', 'two', 'three', 'four'],
                            correctAnswer: 'three'
                        },
                        {
                            question: { en: 'What is the Vietnamese word for "eight"?', vi: 'Từ tiếng Việt cho "eight" là gì?' },
                ...
                },
                {
                    ...
                    exercises: [
                        {
                            question: { en: 'What color is the sky usually?', vi: 'Bầu trời thường có màu gì?' },
                            options: ['red', 'blue', 'green', 'yellow'],
                            correctAnswer: 'blue'
                        },
                        {
                            question: { en: 'What is the color of grass?', vi: 'Cỏ có màu gì?' },
                            options: ['red', 'blue', 'green', 'purple'],
                            correctAnswer: 'green'
                        },
                        {
                            question: { en: 'Which color is not a primary color?', vi: 'Màu nào không phải là màu cơ bản?' },
